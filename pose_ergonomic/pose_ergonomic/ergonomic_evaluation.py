...
def scoring(keypoints_front, keypoints_side, load):
	...
	if max(angle_uarmr,angle_uarml) > 45:	#score3
	...
	angle_shoulder = min(angle_shoulderr,angle_shoulderl)
	...
	if 34 in keypoints_side_zeros or angle_larml ==0:
		...
		angle_wristl = line_angle(keypoints_side[6,:], keypoints_side[7,:], keypoints_side[7,:], keypoints_side[34,:])	#left wrist
	if 43 in keypoints_side_zeros or angle_larmr ==0:
		angle_wristr = 0
	else: 
		angle_wristr = line_angle(keypoints_side[3,:], keypoints_side[4,:], keypoints_side[4,:], keypoints_side[55,:])
	...
	if 9 in keypoints_side_zeros or 10 in keypoints_side_zeros or 11 in keypoints_side_zeros:
		...
		angle_legr = line_angle(keypoints_side[9,:], keypoints_side[10,:], keypoints_side[11,:], keypoints_side[10,:])
	if 12 in keypoints_side_zeros or 13 in keypoints_side_zeros or 14 in keypoints_side_zeros:
		angle_legl = 0
	else:
		angle_legl = line_angle(keypoints_side[12,:], keypoints_side[13,:], keypoints_side[14,:], keypoints_side[13,:])
	...
	#step4 wrist twist
	if 25 in keypoints_front_zeros or 26 in keypoints_front_zeros or 42 in keypoints_front_zeros:
		angle_wristtwl = 0
	else:
	...
	#step4
	if angle_wristtw <20:	#20 is angle value when hand at handshake position, maybe varies
		W2 =  W2+1
	else:
		W2 = W2+2
