...
def img_synchronizer():
	...
	global side_pub
	global front_pub
	side_pub = rospy.Publisher('side_img', Image, queue_size=1)
	front_pub = rospy.Publisher('front_img', Image, queue_size=1)

	sub_side  = message_filters.Subscriber("/logi_c922_1/image_rect_color", Image, queue_size=10, buff_size=110592*6 )
	sub_front = message_filters.Subscriber("/logi_c922_2/image_rect_color", Image, queue_size=10, buff_size=110592*6 )
